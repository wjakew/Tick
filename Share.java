...
public class Share {
    ...
    int owner_id;
    ArrayList<Tick_ShareObject> to_do;
    boolean filled;
  
    Database database;
    int status = -2;
    
    Share( Database database ) throws SQLException{
     ...
     * -4 - database fail
     */
    int share_tick(int tick_id,int owner_to) throws SQLException{
     ...
     * Making share done
     */
    boolean share_done(int share_id) throws SQLException{
     ...
     */
    int share_load() throws SQLException{
     ...
     * -1 - internal fail
     */
   int share_check_database() throws SQLException{
       owner_id = database.logged.owner_id;
    ...
    */
   ArrayList<String> return_data() throws SQLException{
    ...
    */
   ArrayList<String> return_data_history() throws SQLException{
       ArrayList<String> to_ret = new ArrayList<>();
