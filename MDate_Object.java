...
public class MDate_Object {
     ...
     * @return String
     */
    String number_0adder(int number){
     ...
     * @return String
     */
    String month_number_translator(){
     ...
     * @return String
     */
    String string_adder(String data,String separator,String source){
