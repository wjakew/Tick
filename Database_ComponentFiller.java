...
public class Database_ComponentFiller {
     ...
     * @param database 
     */
    Database_ComponentFiller(Database database){
     ...
     */
    DefaultListModel translator(ArrayList<String> data){
     ...
     */
    ArrayList<String> datagather_simpleview(String mode) throws SQLException{
