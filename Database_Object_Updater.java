...
public class Database_Object_Updater {
     ...
     * scene
     */
    Database_Object_Updater(Database database){
     ...
     * @return String
     */
    String update_query(String mode){
     ...
     * @return 
     */
    int count_variables(String data_to_count){
     ...
     * @return boolean
     */
    boolean update_record(ArrayList<Tick_Brick> data,String mode) throws SQLException{
